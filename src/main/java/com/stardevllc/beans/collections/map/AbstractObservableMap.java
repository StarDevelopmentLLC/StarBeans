...
import com.stardevllc.beans.collections.handler.MapListenerHandler;
...
public abstract class AbstractObservableMap<K, V> implements ObservableMap<K, V> {
    ...
    public static class ObservableEntry<K, V> implements Entry<K, V> {
        private final AbstractObservableMap<K, V> backingMap;
        private final Entry<K, V> backingEntry;
        
        public ObservableEntry(AbstractObservableMap<K, V> backingMap, Entry<K, V> backingEntry) {
